    ...
    <Container id="home">
      <div className="hero-text">
        ...
        <ScrollAnimation animateIn="fadeInUp" delay={0.4 * 1000}>
          ...
          <h4>BTW⭐⭐⭐I have Made Best Microsoft Teams app  in the World in 2022</h4>
          &nbsp;
        </ScrollAnimation>
        <ScrollAnimation animateIn="fadeInUp" delay={0.6 * 1000}>
          <p className="small-resume">More then four years of experience facilitating cutting-edge engineering solutions with a wide range of web application and technology skills. Proven ability to leverage full-stack expertise to build interactive and user-centered website designs to scale. Extensive expertise in large system architecture development and administration, as well as network design and configuration.
</p>
        </ScrollAnimation>
